...
print('y_quad_fit :', y_quad_pred)

# 성능 비교
print('MSE 비교 : 선형모델:%.3f, 다항모델:%.3f'%(mean_squared_error(y, y_lin_pred), mean_squared_error(y, y_quad_pred)))
print('MSE 비교 : 선형모델:%.3f, 다항모델:%.3f'%(r2_score(y, y_lin_pred), r2_score(y, y_quad_pred)))

# 데이터가 비선형인 경우에는 선형회귀 모델 보다는 다항회귀 모델을 사용한 경우 모델의 성능이 우수함을 알 수 있다.
