...
print("종편시청 시간 예측 : ", model2.slope * 0.5 + model2.intercept)
print("종편시청 시간 예측 : ", model2.slope * 5.5 + model2.intercept)
# 지상파 시청시간이 늘어날 수록 종편시청 시간도 늘어나는것을 확인.

time = float(input('지상파 시청시간을 입력하세요'))
# print("운동 시간 예측 : ", model.slope * time + model.intercept)
# print("종편시청 시간 예측 : ", model2.slope * time + model2.intercept)

fit_value1 = np.polyval([model.slope, model.intercept], time)
fit_value2 = np.polyval([model2.slope, model2.intercept], time)
print("운동 시간 :", fit_value1)
print("종편시청시간 : ", fit_value2)