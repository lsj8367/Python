...
model.fit(x_data, y_data, epochs = 300, batch_size = 1, verbose=1)
...
print()
print('예측 결과 : ', model.predict([1.345, 7.8]))

from sklearn.metrics import r2_score
print('설명력 : ', r2_score(y_data, model.predict(x_data))) # 설명력 :  0.9486459
