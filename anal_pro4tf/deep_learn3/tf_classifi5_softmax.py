...
ydata = to_categorical(ydata, num_classes=10) # one-hot encoding
print(ydata)
...
print('model_eval : ', model_eval) # [0.24371127784252167, 0.9789999723434448]
